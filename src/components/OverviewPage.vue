<template>
  <div id="smallLinkListView" class="sm-view display">
    <div class="breadcrumbs">
      ...
      <router-link :to="{ name: 'hotspotPage', params: { pageName: pName }}">
        <span>{{ nicePageName }}</span>
      </router-link>
      <span class="breadcrumb-separator">\</span>
      <span>{{ sessionConfig.overview.text }}</span>
    </div>
    <div class="sm-view-wrapper overview-text">

      <span v-html="sessionConfig.overview.links[0].text">
      </span>
